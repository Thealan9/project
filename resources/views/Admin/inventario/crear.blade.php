            ...
            <div class="form-container">
                <form action="{{ route('inventario.store') }} " method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('name_product') border-danger @enderror" name='name_product'  placeholder="Coloque el nombre del producto" >
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('unit_price') border-danger @enderror" name='unit_price'  placeholder="Modelo del producto" >
                        @error('unit_price') @include('fragments.errorsv')@enderror
                    </div>

                    <div class="mb-3">
                        <label class="form-label fw-bold" style="color: #8F8E8E;">Stock</label>
                        <input type="text" class="form-control @error('stock') border-danger @enderror" name='stock'  placeholder="Modelo del producto" >
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($proveedores as $p)
                            <option value="{{ $p->id }}">{{ $p->name_supplier }}</option>
                        @endforeach
                        </select>
